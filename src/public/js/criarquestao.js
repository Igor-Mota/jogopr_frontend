...
function chamar() {
    captar = document.getElementById('tituloquestao').value;
    captar1 = document.getElementById('resposta1').value;
    captar2 = document.getElementById('resposta2').value;
    captar3 = document.getElementById('resposta3').value;

    document.getElementById('teste').innerHTML = captar;
